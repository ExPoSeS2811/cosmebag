...
DROP POLICY IF EXISTS "Users can view their own bag items" ON bag_items;
...
DROP POLICY IF EXISTS "Users can insert their own bag items" ON bag_items;
...
DROP POLICY IF EXISTS "Users can update their own bag items" ON bag_items;
...
DROP POLICY IF EXISTS "Users can delete their own bag items" ON bag_items;
